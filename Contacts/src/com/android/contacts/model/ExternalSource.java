...
public class ExternalSource extends FallbackSource {
    ...
    public void inflate(Context context, int inflateLevel) {
        ...
        inflateSNSKaixin(context, inflateLevel);
        inflateSNSRenren(context, inflateLevel);
        inflateSNSFacebook(context, inflateLevel);
        inflateSNSFlickr(context, inflateLevel);
        inflateSNSTwitter(context, inflateLevel);
