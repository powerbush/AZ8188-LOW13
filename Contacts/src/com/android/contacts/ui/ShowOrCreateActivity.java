...
public final class ShowOrCreateActivity extends Activity implements
    ...
    private boolean mClickBtn = true;;
    ...
    protected Dialog onCreateDialog(int id) {
	    ...
	    case CREATE_CONTACT_DIALOG:
	    	...
	    	final Intent createExistingIntent = new Intent(Intent.ACTION_INSERT_OR_EDIT);
            createExistingIntent.putExtras(mCreateExtras);
            createExistingIntent.setType(RawContacts.CONTENT_ITEM_TYPE);
            ...
            createIntent.setType(RawContacts.CONTENT_TYPE);
                ...
                final CharSequence message = getResources().getString(
                        R.string.add_contact_dialog_message, mCreateDescrip);

                return new AlertDialog.Builder(this)
                        .setTitle(mCreateDescrip)
                        .setMessage(message)
                        .setPositiveButton(R.string.add_contact_dialog_existing,
                                new IntentClickListener(this, createExistingIntent))
                        .setNegativeButton(R.string.add_contact_dialog_new,
    ...
    private static class IntentClickListener implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (mIntent != null) {
                ...
                if (((ShowOrCreateActivity) mParent).mClickBtn) {
                    ((ShowOrCreateActivity) mParent).mClickBtn = false;
