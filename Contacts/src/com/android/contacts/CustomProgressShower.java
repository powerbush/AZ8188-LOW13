...
import com.android.contacts.CustomProgressDialog;

public class CustomProgressShower implements VCardEntryHandler {
    public static final String LOG_TAG = "CustomProgressShower"; 
    ...
    private class ShowProgressRunnable implements Runnable {
        ...
        public void run() {
        	mProgressDialog.setProgressSubMsg1(mFileName);
            mProgressDialog.setProgressSubMsg2(mContact.getDisplayName());
            mProgressDialog.incrementProgressBy(1);
        }
    }
    
    public CustomProgressShower(CustomProgressDialog progressDialog,
            Context context,
        ...
        if (!contactStruct.isIgnorable()) {
            if (mProgressDialog != null) {
                if (mHandler != null) {
                	...
                	mProgressDialog.setProgressSubMsg2(contactStruct.getDisplayName());
                }
            }
        }
