 ...
 * {@link android.widget.MultiLayoutAdapter.ViewBinder} is available,
 ...
 */
public class MultiLayoutAdapter extends BaseAdapter implements Filterable {
    private int[] mTo;
     ...
     */
    public MultiLayoutAdapter(Context context, List<? extends Map<String, ?>> data,
	...
	public int getItemViewType(int position) {
		Integer result = (Integer)mData.get(position).get("ViewLayoutType");
		int iRet = 0;
		if(result == null)
		{
			iRet = 0;
		...
		else
		{
			...
			{
				iRet = 0;
				Log.d("com.mediatek.sns", "result.intValue() happened exception!!");
				e.printStackTrace();
			}
		}
		return iRet;
    ...
    private View createViewFromResource(int position, View convertView,
        ...
        View v;
        if (convertView == null) {
            v = mInflater.inflate(resource[getItemViewType(position)], parent, false);
        } else {
            v = convertView;
        }
    ...
    private void bindView(int position, View view) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                int type = -1;
        		final Object dt = dataSet.get(from[count]);
        		if (dt instanceof Integer)
        		{
        			type = (Integer)dt;
        			Log.d("com.mediatek.sns.contacts","type is "+ type);
        		}
                ...
                if (!bound) {
                	if (v instanceof Checkable) {
                		...
                		setViewText((TextView) v, (CharSequence)data, type);
     ...
     *
     * @see #setViewBinder(android.widget.MultiLayoutAdapter.ViewBinder)
     */
    ...
    public void setViewImage(ImageView v, int value) {
    	Log.d("com.mediatek.sns", "setViewImage  v is "+v+"\t value is "+value);
	 ...
	 * @param v TextView to receive text
	 * @param text the text to be set for the TextView
	 * @param textType The emotion text type
	 */
	public void setViewText(TextView v, CharSequence text, int textType) 
	{
		long start = System.currentTimeMillis();
		if(EmotionParser.getEmotionParserState()<=0)
		{
			Log.e("com.mediatek.sns", "EmotionParser.getEmotionParserState()<=0, so need to init..");
			EmotionParser.init(0, v.getContext());	
		...
		Log.e("com.mediatek.sns", "Contacts    setViewText used "+(end-start)+"ms");
//		v.setText(EmotionParser.getInstance().addSmileySpans(text,textType));
	}
     ...
     *
     * @see MultiLayoutAdapter#setViewImage(ImageView, int)
     * @see MultiLayoutAdapter#setViewImage(ImageView, String)
     * @see MultiLayoutAdapter#setViewText(TextView, String)
     */
