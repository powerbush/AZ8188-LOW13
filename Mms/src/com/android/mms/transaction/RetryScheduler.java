            ...
            try {
                if ((cursor.getCount() == 1) && cursor.moveToFirst()) {
                    ...
                    if ((retryIndex < scheme.getRetryLimit()) && retry) {
                        ...
                        if (MmsApp.DEBUG) {
                            Log.d("MMSLog", uri + " is scheduled at " + scheme.getWaitingInterval());
                        }
        ...
        if (cursor != null) {
            try {
                if (cursor.moveToFirst()) {
                    ...
                    if (retryAt == 0) {
                        Log.d("MMSLog", "pendingid=" + id + "; ra=" + retryAt);
                    ...
                    if (MmsApp.DEBUG) {
                        Log.d("MMSLog", "Next is scheduled at" + (retryAt - SystemClock.elapsedRealtime()) 
