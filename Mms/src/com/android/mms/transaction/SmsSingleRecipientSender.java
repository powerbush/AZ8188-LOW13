...
public class SmsSingleRecipientSender extends SmsMessageSender {
    ...
    public boolean sendMessage(long token) throws MmsException {
        if (MmsApp.DEBUG) {
            Log.d("MMSLog", "SmsSingleRecipientSender: sendMessage()");
        }
        ...
        if (MmsApp.DEBUG) {
            Log.d("MMSLog", "SmsSingleRecipientSender: sendMessage(), Message Count=" + messageCount);
        }
        ...
        try {
            if (MmsApp.DEBUG) {
                Log.d("MMSLog", "\t Destination\t= " + mDest);
                Log.d("MMSLog", "\t ServiceCenter\t= " + mServiceCenter);
                Log.d("MMSLog", "\t Message\t= " + messages);
                Log.d("MMSLog", "\t uri\t= " + mUri);
            }
    ...
    public boolean sendMessageGemini(long token, int simId) throws MmsException {
        ...
        if (MmsApp.DEBUG) {
            Log.d("MMSLog", "SmsSingleRecipientSender: sendMessageGemini() simId=" + simId +"slotId=" + slotId);
        }
        if (mMessageText == null) {
            // Don't try to send an empty message, and destination should be just
            // one.
        ...
        int messageCount = messages.size();
        if (MmsApp.DEBUG) {
            Log.d("MMSLog", "SmsSingleRecipientSender: sendMessageGemini(), Message Count=" + messageCount);
        }
