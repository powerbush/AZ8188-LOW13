    ...
    private SmsMessage updateMessageStatus(Context context, Intent intent) {
        ...
        try {
            if (cursor.moveToFirst()) {
                ...
                if (MmsApp.DEBUG) {
                    Log.d("MMSLog", "updateMessageStatus: msgUrl=" + messageUri 
                ...
                if (oldStatus == Sms.STATUS_FAILED) {
                    ...
                    Log.e("MMSlog","the original status is:"+oldStatus);
                } else {
                    Log.e("MMSlog","the original status is:"+oldStatus+"the last part:"+sendNextMsg);
                ...
                if (MmsApp.DEBUG) {
                    Log.d("MMSLog", "Can't find message for status update: " + messageUri);
                }
            }
        } finally {
            cursor.close();
