...
public class RecipientsEditor extends RecipientsView {
	private static final String COMP_TAG = "Mms/compose";
	...
	public static CharSequence contactToToken(Contact c) {
		Log.v(COMP_TAG, "RecipientsEditor:contactToToken, contact.getName=" + c.getName());
	...
	public void populate(ContactList list) {
		Log.v(COMP_TAG, "RecipientsEditor : populate(ContactsList list), list.size() = " + list.size());
