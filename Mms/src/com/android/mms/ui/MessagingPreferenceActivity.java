...
public class MessagingPreferenceActivity extends PreferenceActivity
    ...
    public void onConfigurationChanged(Configuration newConfig) {
		...
		if ((mSmsDisplayLimitDialog != null)
			...
			} else if (Integer.parseInt(inputString) <= mMmsRecycler.getMessageMinLimit() 
					|| Integer.parseInt(inputString) >= mMmsRecycler.getMessageMaxLimit()) {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mSmsLocation = (ListPreference) findPreference("pref_key_sms_save_location");
  ...
  //MTK_OP02_PROTECT_START
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mSmsLimitPref) {
        	...
        	Intent it = new Intent();
        	it.setClass(this, SmsServiceCenterPreferenceActivity.class);
        	it.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        	it.putExtra("preference", preference.getKey());
        	startActivity(it);
        }
