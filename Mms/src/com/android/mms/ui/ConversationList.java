            ...
            case MENU_SIM_SMS:
            	if(FeatureOption.MTK_GEMINI_SUPPORT == true){
    	            ...
    	            if (listSimInfo.size() > 1) { 
    	            	...
    	            	simSmsIntent.setClass(this, SmsServiceCenterPreferenceActivity.class);
    	            	...
    	            	Log.d(TAG, "MTK_GEMINI_SUPPORT 3 SiMInfo.SLOT = " + listSimInfo.get(0).mSlot);
    	            	startActivity(simSmsIntent);
    	            }
                } else { 
    ...
    private void openThread(long threadId, int type) {
    	if(FeatureOption.MTK_WAPPUSH_SUPPORT == true){
        	...
        	if(type == Threads.WAPPUSH_THREAD){
            	Log.d(WP_TAG, "ConversationList: " + "Start WPMessageActivity.");
                ...
                try {
                    ...
                    if(phone != null) {
                        if(phone.isTestIccCard()) {
                            Log.d(TAG, "All threads has been deleted, send notification..");
