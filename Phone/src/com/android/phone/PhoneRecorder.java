...
//			            .setTitle(R.string.btn_Alertinfo_title)
//                        .setIcon(android.R.drawable.ic_dialog_alert)
//                        .setMessage(mContext.getResources().getText(R.string.alert_device_error))
//                        .setPositiveButton(R.string.str_alertinfo_return, null)
//                        .setCancelable(false)
//                        .create();
//
...
//				mAlertDialog.show();
				Toast.makeText(mContext, mContext.getResources().getText(R.string.alert_device_error), Toast.LENGTH_LONG).show();
			}
		}
	}
