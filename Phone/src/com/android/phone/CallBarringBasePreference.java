...
public class CallBarringBasePreference extends CheckBoxPreference implements
    ...
    private static final String LOG_TAG = "CallBarringBasePreference";
...
/* Fion add end */
    ...
    private void getCallState(String facility, String password, boolean reason) {
        if (DBG)
            Log.i(LOG_TAG, "getCallState() is called with facility is "
...
/* Fion add end */
    ...
    private void setCallState(String facility, boolean enable, String password) {
        if (DBG)
            Log.i(LOG_TAG, "setCallState() is called with facility is "
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetCallBarringResponse(Message msg) {
            ...
            if (ar.exception != null) {
                ...
                {
                	if (DBG) Log.d(LOG_TAG, "BadTokenException");
                }
                ...
                if (ints != null && ints.length > 0) {
                    ...
                    Log.i(LOG_TAG, "Current value = " + value);
                    value = value & mServiceClass;

                    Log.i(LOG_TAG, "After value & 1 = " + value);
                    String summary = null;
                    if (DBG)
                        Log.i(LOG_TAG, "Value is " + value);
                    if (value == 0) {
