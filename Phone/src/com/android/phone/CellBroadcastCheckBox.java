...
public class CellBroadcastCheckBox extends CheckBoxPreference {
    private static final String LOG_TAG = "CellBroadcastCheckBox";
        ...
        private void handleGetStateResponse(Message msg) {
            if (msg.arg2 == MESSAGE_GET_STATE) {
                if (mListener != null){
                    ...
                    if (DBG) Log.d(LOG_TAG, "For init query, there's no reading dialog!");
                }
            } else {
                if (mListener != null)
                {
            ...
            if (ar == null) {
                Log.i(LOG_TAG, "handleGetStateResponse,ar is null");
                if (msg.arg2 == MESSAGE_GET_STATE) {
            ...
            if (ar.exception != null) {
                if (DBG)
                    Log.d(LOG_TAG, "handleGetStateResponse: ar.exception="+ ar.exception);
                if (msg.arg2 == MESSAGE_GET_STATE) {
                    CellBroadcastCheckBox.this.setChecked(false);
                    CellBroadcastCheckBox.this.setEnabled(false);
                }else{
    ...
    private void handleGetCellBroadcastConfigResponse(Message msg) {
        ...
        if (ar.exception != null) {
            ...
            if (ar != null && ar.userObj instanceof Throwable) {
                ...
                Log.d(LOG_TAG,"handleGetCellBroadcastConfigResponse: success!");
            }
        }
    }
