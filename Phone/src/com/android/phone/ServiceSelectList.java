...
public class ServiceSelectList extends DialogPreference 
    ...
    final static String TAG = "ServiceSelectList";
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        Log.i(TAG, "onDialogClosed : mSelected = " + mSelected);
        Log.i(TAG, "onDialogClosed : mInitValue = " + mInitValue);

        if (positiveResult) {
            Log.i(TAG, "callChangeListener");
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        Log.i(TAG,"current select is " + mSelected);
            ...
            if (itemView == null) {
                ...
                if (imageSim != null) {
                    ...
                    if(simItem.mIsSim == true) {
                        ...
                        if(text3G != null) {
                             if((Utils.mSupport3G == false)||(simItem.mSlot != Phone.GEMINI_SIM_1)){
                        ...
                        if ((textNumFormat != null) && (simItem.mNumber!=null)) {
                            ...
                            Log.i(TAG, "format is " + simItem.mDispalyNumberFormat);
    ...
    void dismissSelf() {
        Log.d(TAG, "Dismiss the select list.");     
