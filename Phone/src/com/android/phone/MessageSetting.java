...
public class MessageSetting extends ListActivity
        {
    private static final String LOG_TAG = "MessageSetting";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Log.d("Call additional settings", "Sim Id : " + mSimId);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		Log.v(LOG_TAG,"onOptionsItemSelected start...");
...
//            final EditText 
		...
		public synchronized void afterTextChanged(Editable arg0) {
			try{
				...
				if(str == null || str.length() == 0) {
                    ...
                    Log.v(LOG_TAG,"afterTextChanged ...str_length=" + strLength);
                    Log.v(LOG_TAG,"afterTextChanged ...str_getBytes=" + strGbkLength);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		Log.v(LOG_TAG,"onCreateContextMenu start...");
        ...
        Log.v(LOG_TAG,"mPostion:" + mPosition);
		...
		Log.v(LOG_TAG,"onCreateContextMenu end...");
		return;
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		Log.v(LOG_TAG,"onContextItemSelected start...");
		switch (item.getItemId()) {
        	case MENU_DELETE_MESSAGE: {
        		...
        		mMessageAdapter = new ArrayAdapter<String>(this,R.layout.message, mMessages);
        		this.setListAdapter(mMessageAdapter);
        		Log.v(LOG_TAG,"onContextItemSelected end...");
        		return true;
        	}
