...
public class CallCostTotalPreference extends Preference {
    private static final String LOG_TAG = "CallCostTotalPreference";
...
/* Fion add end */
     	 ...
     	 Log.i(LOG_TAG, "getTotalCallCost: send msg to system.");
    }
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetTotalCallCostResponse(Message msg) {
       	 	Log.i(LOG_TAG, "handleGetTotalCallCostResponse: request get from system.");
            if (msg.arg2 == MESSAGE_GET_TOTAL_CALL_COST) {
                mListener.onFinished(CallCostTotalPreference.this, true);
            }
            AsyncResult ar = (AsyncResult) msg.obj;
            if (ar.exception != null) {
                if (DBG) Log.d(LOG_TAG,"handleGetLastCallCostResponse: ar.exception="+ ar.exception);
                if (mListener != null)
