...
public class CallCostLastPreference extends Preference {
    private static final String LOG_TAG = "CallCostLastPreference";
...
/* Fion add end */
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetLastCallCostResponse(Message msg) {
            Log.d(LOG_TAG,"handleGetLastCallCostResponse: request get.");
                ...
                if (ar.userObj instanceof Throwable) {
                    ...
                    if ((String) ar.result != null) {
                        ...
                        if (checkHexStr(lastCallCostNum)) {
                            ...
                            Log.d(LOG_TAG,"handleGetLastCallCostResponse: lastCallCostNum="+lastCallCostNum);
                        } else {
