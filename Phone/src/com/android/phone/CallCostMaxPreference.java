...
public class CallCostMaxPreference extends Preference {
    private static final String LOG_TAG = "CallCostMaxPreference";
...
/* Fion add end */
        ...
        Log.d(LOG_TAG,"setMaxCallCost: send msg to system,maxLimit="+hexStr+"  pin="+pin);
    }
...
/* Fion add end */
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetMaxCallCostResponse(Message msg) {
        	Log.d(LOG_TAG,"handleGetMaxCallCostResponse: request get from system.");	
        ...
        private void handleSetMaxCallCostResponse(Message msg) {
        	Log.d(LOG_TAG,"handleSetMaxCallCostResponse: request get from system.");	
    ...
    private void  handleException(AsyncResult ar){
        ...
        Log.i(LOG_TAG,"= loyee = CallCostMaxPreference errorCode="+errorCode);
        switch(errorCode){
