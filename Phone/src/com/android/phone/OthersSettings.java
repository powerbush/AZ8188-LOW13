...
public class OthersSettings extends PreferenceActivity implements Preference.OnPreferenceChangeListener
{
    ...
    private static final String LOG_TAG = "OthersSettings";
    ...
    class ServiceComplete implements Runnable {
        public void run() {
            ...
            Log.d(LOG_TAG, "ServiceComplete with the result = " + CellConnMgr.resultToString(result));
     ...
     public boolean onPreferenceChange(Preference preference, Object objValue) {
         if (preference == mButtonMr) {
             if (mButtonMr.isChecked()){
                 Log.d("OthersSettings", "onPreferenceChange mButtonReminder turn on"); 
                 mButtonMr.setSummary(getString(R.string.minutereminder_turnon));
             }else{
                 Log.d("OthersSettings", "onPreferenceChange mButtonReminder turn off"); 
             ...
             if (mButtonDualMic.isChecked()){
                 Log.d(LOG_TAG, "onPreferenceChange mButtonDualmic turn on"); 
                 mButtonDualMic.setSummary(getString(R.string.dual_mic_turnoff));
                 PhoneUtils.setDualMicMode("0");
             }else{
                 Log.d(LOG_TAG, "onPreferenceChange mButtonDualmic turn off"); 
