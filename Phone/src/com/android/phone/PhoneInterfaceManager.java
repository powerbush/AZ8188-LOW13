                ...
                case CMD_END_CALL:
                	...
                	{                	
                		try{
                			...
                			if( ics.getVTScreenMode() == VTCallUtils.VTScreenMode.VT_SCREEN_HIDING )
                			{
                				ics.setVTScreenMode(VTCallUtils.VTScreenMode.VT_SCREEN_OPEN);
                				ics.updateVTScreen(ics.getVTScreenMode());
                			}else if( ics.getVTScreenMode() == VTCallUtils.VTScreenMode.VT_SCREEN_RINGING )
                			{
...
/* Fion add start */
                    ...
                    if (FeatureOption.MTK_GEMINI_SUPPORT == true)
                    {
                    	...
                    	{   
                    		try{                	
                    			...
                    			if( ics2.getVTScreenMode() == VTCallUtils.VTScreenMode.VT_SCREEN_HIDING )
                    			{
                    				ics2.setVTScreenMode(VTCallUtils.VTScreenMode.VT_SCREEN_OPEN);
                    				ics2.updateVTScreen(ics2.getVTScreenMode());
                    			}else if( ics2.getVTScreenMode() == VTCallUtils.VTScreenMode.VT_SCREEN_RINGING )
                    			{
                ...
                case CMD_ANSWER_RINGING_CALL_GEMINI:
                    if (FeatureOption.MTK_GEMINI_SUPPORT == true)
                    {
                        //request = (MainThreadRequest) msg.obj;
                        //int simId = (int)(msg.arg1);
                        //log("CMD_ANSWER_RINGING_CALL_GEMINI: msg.arg1" + simId);
