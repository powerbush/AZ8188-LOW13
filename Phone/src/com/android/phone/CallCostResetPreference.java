...
public class CallCostResetPreference extends Preference {
    private static final String LOG_TAG = "CallCostResetPreference";
...
/* Fion add end */
        ...
        Log.i(LOG_TAG, "resetTotalCallCost: send reset total call  msg, pin2="+pin);
    }
...
/* Fion add end */
    ...
    private class MyHandler extends Handler {
        ...
        private void handleResetCallCostResponse(Message msg) {
            Log.i(LOG_TAG, "handleResetCallCostResponse: request get from system.");
            if (mListener != null) {
            ...
            if (ar.exception != null) {
                if (DBG)
                    Log.d(LOG_TAG, "handleResetCallCostResponse: ar.exception="+ ar.exception);
                handleException(ar);
            } else {
                if (DBG)
                    Log.d(LOG_TAG, "handleResetCallCostResponse: re get");
    ...
    private void  handleException(AsyncResult ar){
        ...
        Log.i(LOG_TAG,"= loyee = handleResetCallCostResponse errorCode="+errorCode);
        switch(errorCode){
