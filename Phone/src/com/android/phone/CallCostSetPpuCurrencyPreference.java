...
public class CallCostSetPpuCurrencyPreference extends Preference {
    private static final String LOG_TAG = "CallCostSetPpuCurrencyPreference";
...
/* Fion add end */
    ...
    private void checkPinRetryAndShowDialog() {
        ...
        if (mPinEnterLimit >= 1 && mPinEnterLimit <= 3) {
            ...
            Log.i(LOG_TAG, "can not get the pin2 retries left");
        }
    }
...
/* Fion add end */
        ...
        Log.d(LOG_TAG, "setPpuCurrency:send msg to system,currency="+currency+"  ppu="+ppu+" pin2="+pin2);
    }
...
/* Fion add end */
        ...
        Log.d(LOG_TAG, "getPpuCurrency: send msg to system to get data.");
    }
...
/* Fion add start */
    public void init(TimeConsumingPreferenceListener listener,
        ...
        Log.d(LOG_TAG,"init, simId = "+simId);
...
/* Fion add end */
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetPpuCurrencyResponse(Message msg) {
        	Log.d(LOG_TAG, "handleGetPpuCurrencyResponse: request get from system.");
            ...
            if (ar.exception != null) {
                ...
                if (ar.userObj instanceof Throwable) {
                    ...
                    if (checkPpu(ppu,false) && checkCurrency(currency)) {
                        ...
                        if (DBG)
                            Log.d(LOG_TAG, "handleGetPpuCurrencyResponse: data format error");
                        setSummary(R.string.disable);
                    }
                }
            }
        ...
        private void handleSetPpuCurrencyResponse(Message msg) {
        	Log.d(LOG_TAG, "handleSetPpuCurrencyResponse: request get from system.");
    ...
    private void  handleException(AsyncResult ar){
        ...
        Log.i(LOG_TAG,"= loyee = CallCostSetPpuCurrencyPreference errorCode="+errorCode);
        switch(errorCode){
